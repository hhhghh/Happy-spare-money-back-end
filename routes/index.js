...
router.get('/', async (ctx, next) => {
    ...
    let a = undefined
    if (search.username != undefined && search.task_id != undefined && search.score != undefined) {
        a = await TRModel.comfirm_complement(search.username, search.task_id, search.score)
    } else {
        a = 'Not implement'
    }
    ctx.body = a
